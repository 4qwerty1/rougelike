...
//  }
//}
//Map::Map(shared_ptr<Characters> characters, shared_ptr<Factory> factory)
...
//      if (map[i][j] != '.') {
//        characters_->push_back(std::shared_ptr<Character>(factory_->create(map[i][j], j, i)));
//      }
//    }
//  }
//
//  std::sort(characters_->begin(), characters_->end(), comp);
//}